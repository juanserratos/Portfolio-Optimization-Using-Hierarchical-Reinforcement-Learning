"""
Fixed version of data processor with no relative imports and updated fillna usage.
"""
import logging
import pandas as pd
import numpy as np
    ...
    def calculate_technical_indicators(self):
        ...
        for ticker in self.tickers:
            try:
                ...
                # 3. Moving averages - FIXED: Use bfill() instead of fillna(method='bfill')
                ma_5 = price.rolling(5).mean().bfill() / price - 1
                ma_20 = price.rolling(20).mean().bfill() / price - 1
                ma_50 = price.rolling(50).mean().bfill() / price - 1
                ...
                # 5. Volume features - FIXED: Use bfill() instead of fillna(method='bfill')
                volume_ma_5 = volume.rolling(5).mean().bfill()
